...
export class AuthService {
  ...
  signindb(email, password): Observable<any> {
    ...
    return this.http.post("http://192.168.1.8/tasiuks/api/login.php", body);
  }
  ...
  updateUid(email, token): Observable<any> {
    ...
    return this.http.post("http://192.168.1.8/tasiuks/api/updateloginuid.php", body);
  }
  //kirim chat ke db 
  sendChatDb(ortuid, petugasid, msg, pengirim): Observable<any> {
    ...
    return this.http.post("http://192.168.1.8/tasiuks/api/insertchat.php", body);
  }
  //ambil petugas status aktif
  getPetugasAktif(): Observable<any> {
    return this.http.get("http://192.168.1.8/tasiuks/api/getPetugasAktif.php");
  }
  getPeriodeAktif(): Observable<any> {
    return this.http.get("http://192.168.1.8/tasiuks/api/getPeriodeAktif.php");
  ...
  updateTokenDevicePetugas(token, id): Observable<any> {
    ...
    return this.http.post("http://192.168.1.8/tasiuks/api/updatetokendevicepetugas.php", body);
  }
  getListChat(id): Observable<any> {
    let body = new HttpParams();
    body = body.set('petugasid', id);
    return this.http.post("http://192.168.1.8/tasiuks/api/getlistchat.php", body);
  }

  getListContact(): Observable<any> {
    return this.http.get("http://192.168.1.8/tasiuks/api/getlistcontact.php");
  }

  getListKelas(): Observable<any> {
    return this.http.get("http://192.168.1.8/tasiuks/api/getlistkelas.php");
  }
  getListKelasPerizinan(id): Observable<any> {
    let body = new HttpParams();
    body = body.set('kegiatanid', id);
    return this.http.post("http://192.168.1.8/tasiuks/api/getlistkelasperizinan.php", body);
  }
  listInformasiPetugas(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getinformasipetugas.php", body);
  }
  listDetailInfo(infoid): Observable<any> {
    let body = new HttpParams();
    body = body.set('infoid', infoid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdetailinfo.php", body);
  }
  listDetailPemeriksaan(id): Observable<any> {
    let body = new HttpParams();
    body = body.set('id', id);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdetailpemeriksaan.php", body);
  }
  listDetailPetugas(petugasid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('petugasid', petugasid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdetailpetugas.php", body);
  }
  deleteInfo(infoid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('infoid', infoid);
    return this.http.post("http://192.168.1.8/tasiuks/api/deleteinformasi.php", body);
  }
  listKegiatan(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanuks.php", body);
  }
  listJenis(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getjeniskegiatan.php", body);
  }
  listDetailKegiatan(kegiatanid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('id', kegiatanid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdetailkegiatan.php", body);
  }
  deleteKegiatan(kegiatanid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('kegiatanid', kegiatanid);
    return this.http.post("http://192.168.1.8/tasiuks/api/deletekegiatan.php", body);
  }
  listSiswaAccPemeriksaan(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getaccpemeriksaan.php", body);
  }
  listSiswaNotYetAccPemeriksaan(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getaccyetpemeriksaan.php", body);
  }
  listSiswaAccKejadian(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getacckejadian.php", body);
  }
  listSiswaNotYetAccKejadian(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getaccyetkejadian.php", body);
  }
  getJumlahBelumAccPemeriksaan(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahaccyetpemeriksaan.php", body);
  }
  getJumlahBelumAccPerizinan(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahaccyetperizinan.php", body);
  }
  listKegiatanPerizinanPetugas(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanperizinanpetugas.php", body);
  }
  listKelasKegiatanPerizinanPetugas(kegiatanid): Observable<any> {
    let body = new HttpParams();
    body = body.set('kegiatanid', kegiatanid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkelaskegiatanperizinan.php", body);
  }
  listSiswaAccKegiatan(kegiatanid): Observable<any> {
    let body = new HttpParams();
    body = body.set('kegiatanid', kegiatanid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getaccperizinan.php", body);
  }
  listSiswaDenyKegiatan(kegiatanid): Observable<any> {
    let body = new HttpParams();
    body = body.set('kegiatanid', kegiatanid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdenyperizinan.php", body);
  }
  listSiswaNotYetAccKegiatan(kegiatanid): Observable<any> {
    let body = new HttpParams();
    body = body.set('kegiatanid', kegiatanid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getaccyetperizinan.php", body);
  }
  getJumlahPesanPetugas(petugasid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('petugasid', petugasid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahpesanpetugas.php", body);
  }
  updatePesanTerbacaPetugas(petugasid: number, ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('petugasid', petugasid);
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/updatereadpesanpetugas.php", body);
  }
  detailKejadian(kejadianid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('kejadianid', kejadianid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdetailkejadian.php", body);
  }
  getLastKejadianSiswa(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getlastkejadian.php", body);
  }
  getKegiatanTerdekat(): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', this.ortuIdDb);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanterdekat.php", body);
  }
  getKegiatanTerdekatPetugas(): Observable<any> {
    let body = new HttpParams();
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanterdekatpetugas.php", body);
  }
  listdevicekegiatan(forall: number, cb: any): Observable<any> {
    let body = new HttpParams();
    body = body.set('forall', forall);
    body = body.set('cbkelas', cb);
    return this.http.post("http://192.168.1.8/tasiuks/api/getlistdevicekegiatan.php", body);
  }
  ...
  updateTokenDeviceOrtu(token, id): Observable<any> {
    ...
    return this.http.post("http://192.168.1.8/tasiuks/api/updatetokendeviceortu.php", body);
  }
  //rekam medis
  listSiswa(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getlistsiswa.php", body);
  }
  ...
  listRekamMedis(siswaid: number, periodeid: number): Observable<any> {
    ...
    return this.http.post("http://192.168.1.8/tasiuks/api/getrekammedis.php", body);
  }

  listDetailSiswa(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdetailsiswa.php", body);
  }
  listPeriodeSiswa(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getlistperiode.php", body);
  }
  updatePemeriksaan(idlaporan: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('id', idlaporan);
    return this.http.post("http://192.168.1.8/tasiuks/api/updateconfirmpemeriksaan.php", body);
  }
  listKejadian(siswaid: number, periodeid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    body = body.set('periodeid', periodeid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getlistkejadian.php", body)
  }
  updateKejadian(idlaporan: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('id', idlaporan);
    return this.http.post("http://192.168.1.8/tasiuks/api/updateconfirmkejadian.php", body);
  }

  listInformasiOrtu(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getinformasiortu.php", body);
  }

  listDetailOrtu(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getdetailortu.php", body);
  }
  getJumlahPerizinan(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahperizinanortu.php", body);
  }
  getJumlahPerizinanAll(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahperizinanortuall.php", body);
  }
  listKegiatanPerizinan(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanperizinanortu.php", body);
  }
  listKegiatanPerizinanAll(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanperizinanortuall.php", body);
  }
  ...
  updatePerizinanKegiatan(siswaid: number, kegiatanid: number, ortuid: number, kelasajaranid: number, periodeajaranid: number): Observable<any> {
    ...
    return this.http.post("http://192.168.1.8/tasiuks/api/updateperizinankegiatan.php", body);
  }
  getJumlahPemeriksaan(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahpemeriksaan.php", body);
  }
  getJumlahKejadian(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahkejadian.php", body);
  }
  getKegiatanOrtuAllAcc(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanortuallacc.php", body);
  }
  getKegiatanOrtuAllNot(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanortuallnot.php", body);
  }
  getKegiatanOrtuKelasAcc(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanortukelasacc.php", body);
  }
  getKegiatanOrtuKelasNot(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanortukelasnot.php", body);
  }
  getKegiatanOrtuNonPerizinan(siswaid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('siswaid', siswaid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getkegiatanortunonperizinan.php", body);
  }
  getJumlahPesanOrtu(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/getjumlahpesanortu.php", body);
  }
  updatePesanTerbacaOrtu(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    return this.http.post("http://192.168.1.8/tasiuks/api/updatereadpesanortu.php", body);
  }
  ...
  logoutortu(ortuid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('ortuid', ortuid);
    body = body.set('keterangan', 'ortu');
    return this.http.post("http://192.168.1.8/tasiuks/api/logout.php", body);
  }
  logoutpetugas(petugasid: number): Observable<any> {
    let body = new HttpParams();
    body = body.set('petugasid', petugasid);
    body = body.set('keterangan', 'petugas');
    return this.http.post("http://192.168.1.8/tasiuks/api/logout.php", body);
  }
