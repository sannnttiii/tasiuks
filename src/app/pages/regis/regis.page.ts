        ...
        .then((data) => {
          ...
          this.afs.collection('user').doc(data.user.uid).set({
            ...
            .then(() => {
              ...
              this.http.post("http://192.168.1.2/tasiuks/api/regis.php", formData).subscribe((data) => {
                if (data['status']) {
                  console.log('success')
        ...
        .then((data) => {
          ...
          this.afs.collection('user').doc(data.user.uid).set({
            ...
            .then(() => {
              ...
              this.http.post("http://192.168.1.2/tasiuks/api/regispetugas.php", formData).subscribe((data) => {
                if (data['status']) {
                  console.log('success')
